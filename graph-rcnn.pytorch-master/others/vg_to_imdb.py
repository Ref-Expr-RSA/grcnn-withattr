...
def add_images(im_data, h5_file, args):
    ...
    for i, img in enumerate(im_data):
        ...
        filename1 = os.path.join('/projectnb/llamagrp/shawnlin/ref-exp-gen/dataset/visual_genome/raw_zip/test/VG_100K/', basename)
        filename2 = os.path.join('/projectnb/llamagrp/shawnlin/ref-exp-gen/dataset/visual_genome/raw_zip/test/VG_100K_2/', basename)
